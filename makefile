...
$(OBJ_DIR)/randomMutator.o: $(INC_DIR)/mutator.h $(INC_DIR)/itemSet.h $(INC_DIR)/itemSetC.h
$(OBJ_DIR)/mutator.o: $(INC_DIR)/individual.h $(INC_DIR)/itemSet.h $(INC_DIR)/itemSetC.h
...
$(OBJ_DIR)/cross.o: $(INC_DIR)/individual.h $(INC_DIR)/itemSet.h $(INC_DIR)/itemSetC.h
...
$(OBJ_DIR)/geneticAlgo.o : $(INC_DIR)/geneticAlgo.h $(INC_DIR)/individual.h $(INC_DIR)/dataSet.h
