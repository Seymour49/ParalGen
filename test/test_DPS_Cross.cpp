...
int main(int argc, char **argv) {
   ...
   */
    ...
    ItemSetC* child3 = mpcross->execute(ditc,ditc2);
     cout << "ditc   : ";
    for( unsigned i=0; i <= pivots[0] ; ++i)
      cout << ditc->getBitsetAt(i);
    cout << " | ";
    for(unsigned i=pivots[0]+1; i < pivots[1]; ++i)
      cout << ditc->getBitsetAt(i);
    cout << " | ";
    for(unsigned i=pivots[1]+1; i < pivots[2]; ++i)
      cout << ditc->getBitsetAt(i);
     cout << " | ";
    for(unsigned i=pivots[2]+1; i < child3->getSize(); ++i)
      cout << ditc->getBitsetAt(i);
    cout << endl;
     cout << "ditc2  : ";
    for( unsigned i=0; i <= pivots[0] ; ++i)
      cout << ditc2->getBitsetAt(i);
    cout << " | ";
    for(unsigned i=pivots[0]+1; i < pivots[1]; ++i)
      cout << ditc2->getBitsetAt(i);
    cout << " | ";
    ...
    for(unsigned i=pivots[1]+1; i < pivots[2]; ++i)
      cout << dit->getBitset()[i];
     cout << " | ";
    for(unsigned i=pivots[2]+1; i < child4->getSize(); ++i)
      cout << dit->getBitset()[i];
    cout << endl;
     cout << "dit2  : ";
    for( unsigned i=0; i <= pivots[0] ; ++i)
      cout << dit2->getBitset()[i];
    cout << " | ";
    for(unsigned i=pivots[0]+1; i < pivots[1]; ++i)
      cout << dit2->getBitset()[i];
    cout << " | ";
